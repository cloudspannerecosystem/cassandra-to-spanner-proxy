...
func main() {
	ctx, cancel := signalContextForProxy(context.Background(), os.Interrupt, os.Kill)
	defer cancel()
...
func signalContextForProxy(parent context.Context, sig ...os.Signal) (context.Context, func()) {
